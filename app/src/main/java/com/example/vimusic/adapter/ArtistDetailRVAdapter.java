...
public class ArtistDetailRVAdapter extends RecyclerView.Adapter<ArtistDetailRVAdapter.ItemHolder> {

    private Context context;

    private List<BaiHat> baiHatList;

    public ArtistDetailRVAdapter(Context context, List<BaiHat> baiHatList) {
