...
public class AlbumDetailRVAdapter extends RecyclerView.Adapter<AlbumDetailRVAdapter.ItemHolder> {

    private Context context;

    private List<BaiHat> baiHatList;

    public AlbumDetailRVAdapter(Context context, List<BaiHat> baiHatList) {
